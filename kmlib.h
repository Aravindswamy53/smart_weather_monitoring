...
//------------UART_Init------------
// Baudrate support 9600 & 115200 (assuming 50 MHz clock),
// 8 bit word length, no parity bits, one stop bit, FIFOs Disabled
// Input: none
// Output: none
void KM_UART1_Config(int );

void KM_UART1_Interrupt(void); // Rx Interrupt & RX time out Interrupt Enable
...
// U2Rx (VCP receive) connected to PD6
// U2Tx (VCP transmit) connected to PD7
void KM_UART2_Config(int); // baudrate support 9600 & 115200
void KM_UART2_Interrupt(void);// Rx Interrupt & RX time out Interrupt Enable
void KM_UART2_OutChar(unsigned char );
void KM_UART2_OutString(char *);
unsigned char KM_UART2_InChar(void);
void KM_UART2_InString(char *,unsigned short);

// U3Rx (VCP receive) connected to PC6
// U3Tx (VCP transmit) connected to PC7
void KM_UART3_Config(int); // baudrate support 9600 & 115200
void KM_UART3_Interrupt(void);// Rx Interrupt & RX time out Interrupt Enable
void KM_UART3_OutChar(unsigned char );
void KM_UART3_OutString(char *);
unsigned char KM_UART3_InChar(void);
void KM_UART3_InString(char *,unsigned short);
